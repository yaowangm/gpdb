...
typedef struct PlannedStmt
{
	...
	/* A hash table accomodating set of query strings (packed DispatchCommandQueryParms)
	 * for different kinds of segments.
	 * Key is nsegments (number of primary segments on host), and entry is query
	 * string with different query_mem/operatorMemKB generated by buildGpQueryString().
	 */
