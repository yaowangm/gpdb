...
/* nranges = (2^40 - 1) / APPENDONLY_VISIMAP_MAX_RANGE + 1 = 2^25 */
#define AOVISIMAP_ALLVISIBLESET_MAX_RANGE_COUNT \
	((AOTupleId_MaxRowNum + 1) >> AOVISIMAP_ALLVISIBLESET_SHIFT)
/* nbms = AOVISIMAP_ALLVISIBLESET_MAX_RANGE_COUNT / BITS_PER_BITMAPWORD / APPENDONLY_VISIMAP_MAX_BITMAP_WORD_COUNT = 2^10 */
