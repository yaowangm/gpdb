-- Disable gp_enable_mk_sort, so follow classic qsort algorithm for sort
...
-- Repeat all the tests by mk qsort

-- Enable gp_enable_mk_sort, to follow mk qsort algorithm for sort
